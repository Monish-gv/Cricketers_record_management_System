...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 text-center">
            ...
            <p class="lead">The cricketers record management system is used to analyse create and store all the records of legendary cricketers this includes runs ,wickets matches ,high score and other attributes here we can maintain the database and view all the attributes related to a player</p>
    ...
    <div class="padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <img src="../Landing Page/img/bg.png" alt="" class="img-responsive">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="copyright">
      <p>©2023 | All right reserved by Monish & Gaurav</p>
    </div>
